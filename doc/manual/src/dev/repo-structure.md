...
│       └── StatusBar.{cpp,hpp}
└── tests/
    ├── test_grammar.cpp     # 397 aserciones, sin Scilab
    └── test_integration.cpp # 530 aserciones, 31 escenarios con scilab-cli
```
...
undo/redo sin levantar ventana —397 aserciones en milisegundos—.
