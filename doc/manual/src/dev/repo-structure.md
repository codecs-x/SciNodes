...
│       └── StatusBar.{cpp,hpp}
└── tests/
    ├── test_grammar.cpp     # 378 aserciones, sin Scilab
    └── test_integration.cpp # 309 aserciones, 28 escenarios con scilab-cli
```
...
undo/redo sin levantar ventana —378 aserciones en milisegundos—.
