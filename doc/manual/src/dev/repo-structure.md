...
│       └── StatusBar.{cpp,hpp}
└── tests/
    ├── test_grammar.cpp     # 192 aserciones, sin Scilab
    └── test_integration.cpp # 234 aserciones, 15 escenarios con scilab-cli
```
...
undo/redo sin levantar ventana —192 aserciones en milisegundos—.
